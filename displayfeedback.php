...
<table border="1" class="table">
        <thead>
            <tr>
                ...
                <th scope="col" class="th1">Feedback</th>
...
<center> 
                ...
                <a href="feedbackupdate.php?updatename='.$id.'"><button class="up">Update</button></a>

                <a href="feedbackdelete.php?deletename='.$id.'"><button class="del"><p  class="delp">Delete</p></button></a>
</center>
                    </tr>';
                }
            }
